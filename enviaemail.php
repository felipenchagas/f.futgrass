...
try {
     ...
     $mail->Host = 'mail.futgrass.com.br'; // Endereço do servidor SMTP (Autenticação, utilize o host smtp.seudomínio.com)
     $mail->SMTPAuth   = true;  // Usar autenticação SMTP (obrigatório para smtp.seudomínio.com)
     $mail->Port       = 587; //  Usar 587 porta SMTP
     $mail->Username = 'futgrass@futgrass.com.br'; // Usuário do servidor SMTP (endereço de email)
     $mail->Password = 'Futgrass80802!'; // Senha do servidor SMTP (senha do email usado)
$mail->AddAddress('futgrass@futgrass.com.br', 'FUTGRASS');
     //Define o remetente
     // =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=    
     $mail->SetFrom('futgrass@futgrass.com.br', "$nomeremetente"); //Seu e-mail
     $mail->AddReplyTo('futgrass@futgrass.com.br', 'Nome'); //Seu e-mail	
